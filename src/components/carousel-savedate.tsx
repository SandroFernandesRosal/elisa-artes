...
export default function CarouselSaveDate({ products }: InvitationArray) {
  ...
  return (
    <div className="w-[80vw]   pt-10">
        <div className='flex justify-between items-center px-2 py-5'><h1 className=" text-3xl font-bold mb-4 border-l-8 pl-2 border-primary rounded-lg">Save the date</h1> <p className='flex gap-2 hover:text-primary cur text-lg items-center'>Ver todos <CornerRightDown size={32} /> </p></div>
